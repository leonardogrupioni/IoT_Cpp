//Codigo do projeto Campainha Inteligente com ESP32-CAM e Telegram
...
const char* ssid = "AndroidAPJ";  //WiFi Name
...
String unlockDoor(){  
 if (lockState == 0) {
  ...
  lockState = 1;
  delay(100);
  return "Porta aberta. /lock";
 }
 else{
  return "A Porta já esta Aberta. /lock";
 }  
}
String lockDoor(){
 if (lockState == 1) {
  ...
  lockState = 0;
  delay(100);
  return "Porta fechada. /unlock";
 }
 else{
  return "A Porta já esta fechada. /unlock";
 }
}
...
String sendPhotoTelegram(){
  ...
  String welcome = "Campainha Tocando!\n";
  welcome += "/photo : Tira uma nova foto\n";
  welcome += "/unlock : Abrir a porta\n\n";
  welcome += "/lock : Fechar a porta\n";
  welcome += "Para uma nova foto mande /photo.\n";
